...
PKG_DEPENDS_TARGET="toolchain boost Python zlib bzip2 systemd pciutils lzo pcre swig:host libass enca curl rtmpdump fontconfig fribidi tinyxml libjpeg-turbo libpng tiff freetype jasper libogg libcdio libmodplug libmpeg2 taglib libxml2 libxslt yajl sqlite libvorbis ffmpeg MuMuDVB kodi:host"
...
# install project specific configs
  mkdir -p $INSTALL/usr/share/kodi/config
    ...
    if [ -f $PROJECT_DIR/$PROJECT/devices/$DEVICE/kodi/sources.xml ]; then
